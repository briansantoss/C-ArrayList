...
static bool is_in_bounds(ArrayList *ArrayList); // Verifica se uma posição está dentro ou não dos limites do ArrayList (0 <= position < size)
...
ArrayList *append(ArrayList *arrlist, int value); // Insere o valor passado por parâmetro ao final do ArrayList
ArrayList *insert_at(ArrayList *arrlist, size_t position, int value); // Insere o valor passado via parâmetro na posição informada 

int get(ArrayList *ArrayList, size_t position); // Retorna o valor na posição passada por parâmetro
